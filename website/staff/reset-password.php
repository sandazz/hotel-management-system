...
$query=mysqli_query($con,"update staff set password='$newpassword' where contactNo='$cno' and email='$email'");
if ($query) {
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> RMS | Staff Reset Password</h2></a>
				</div>
...
<i class="fa fa-lock"></i> </span>
					...
					<div class="copyright">
				<span class="text-bold text-uppercase"> Restaurant Management System</span>
					</div>
