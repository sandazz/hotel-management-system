...
$email=$_POST['email'];
$sql=mysqli_query($con,"Update staff set catogary='$catogary',name='$name',address='$address',fees='$fees',contactNo='$contactNo' where id='".$_SESSION['id']."'");
if($sql)
{
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												...
												<div class="panel-body">
													<?php 
													$did=$_SESSION['dlogin'];
													$sql=mysqli_query($con,"select * from staff where email='$did'");
													...
													<form role="form" name="" method="post">
														<div class="form-group">
															...
															<select name="catogary" class="form-control" required="required">
																<option value="<?php echo htmlentities($data['category']);?>"><?php echo htmlentities($data['category']);?></option>
															</select>
														</div>
