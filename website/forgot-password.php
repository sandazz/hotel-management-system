...
$name=$_POST['fullname'];
$email=$_POST['email'];
$query=mysqli_query($con,"select id from  customers where fullName='$name' and email='$email'");
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> RMS | Customer Password Recovery</h2></a>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="text-bold text-uppercase">  Restaurant Management System</span>
					</div>
